@{
    ...
    RequiredModules   = @(
        @{ ModuleName = 'OMG.PSUtilities.ActiveDirectory'; ModuleVersion = '1.0.5' }
        @{ ModuleName = 'OMG.PSUtilities.AI'; ModuleVersion = '1.0.43' }
        @{ ModuleName = 'OMG.PSUtilities.AzureCore'; ModuleVersion = '1.1.0' }
        @{ ModuleName = 'OMG.PSUtilities.AzureDevOps'; ModuleVersion = '1.0.20' }
        @{ ModuleName = 'OMG.PSUtilities.Core'; ModuleVersion = '1.1.0' }
        @{ ModuleName = 'OMG.PSUtilities.ServiceNow'; ModuleVersion = '1.0.1' }
        @{ ModuleName = 'OMG.PSUtilities.VSphere'; ModuleVersion = '1.0.3' }
    )
    FunctionsToExport = @()
    CmdletsToExport   = @()
    VariablesToExport = @()
