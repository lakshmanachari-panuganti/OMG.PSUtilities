...
FunctionsToExport = @('Get-PSUAiPoweredGitChangeSummary', 'Invoke-PSUPromptOnGeminiAi', 'Invoke-PSUPromptOnPerplexityAi', 'New-PSUAiPoweredPullRequest', 'New-PSUGitCommitMessge', 'Start-PSUGeminiChat')
